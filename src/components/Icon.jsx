/**
 * Векторные иконки интерфейса (контурный стиль, 24×24).
 */
const PATHS = {
  ...
  building: (<><rect x="4" y="2" width="16" height="20" rx="2" ry="2" /><path d="M9 22v-4h6v4" /><path d="M8 6h.01M16 6h.01M12 6h.01M8 10h.01M12 10h.01M16 10h.01" /></>),
